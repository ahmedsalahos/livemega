...
function get_mainsite_url(){
    ...
    $url = str_replace('megabackoffice/', '', $HTTP_SERVER);
    return $url;
}
...
function rev_site_admin_url(){
    $get_mainsite_url = get_mainsite_url();
    $url = $get_mainsite_url.'megabackoffice/index.php';
    return $url;
}
...
function get_catalog_path($sub_url = ''){
    $dir_app = str_replace('/megabackoffice/', '/catalog/', DIR_APPLICATION);
    return $dir_app.$sub_url;
}
function get_admin_path($sub_url = ''){
    $dir_app = str_replace('/catalog/', '/megabackoffice/', DIR_APPLICATION);
    return $dir_app.$sub_url;
}
