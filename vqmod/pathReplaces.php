...
**/
$replaces[] = array('~^admin\b~', 'megabackoffice'); // This replaces the admin folder name for use when admin folder's renamed
$replaces[] = array('~\btheme/default\b~', 'theme/cosyone'); // Theme name replace to apply mods to your theme
