...
class ControllerCommonSeoUrl extends Controller {
	...
	public function rewrite($link) {
		...
		foreach ($data as $key => $value) {
			...
			($data['route'] == 'information/information' && $key == 'information_id') || ($data['route'] == 'seller/catalog-seller/profile' && $key == 'seller_id') || ($data['route'] == 'seller/catalog-seller/products' && $key == 'seller_id') || ($data['route'] == 'blog/blog' && $key == 'blog_id'))
			 {
