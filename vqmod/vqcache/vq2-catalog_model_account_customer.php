...
class ModelAccountCustomer extends Model {
	...
	public function getCustomerByEmail($email) {
		...
		return $query->row;
				...
				public function editLiveFreeCustomer($data) {
					$this->event->trigger('pre.customer.edit', $data);
					$customer_id = $data['customer_id'];
               		$this->db->query("UPDATE " . DB_PREFIX . "customer SET firstname = '" . $this->db->escape($data['firstname']) . "', lastname = '" . $this->db->escape($data['lastname']) . "' , percentage_country_id = '" . $this->db->escape($data['country_id']) . "', telephone = '" . $this->db->escape($data['telephone']) . "', fax = '" . $this->db->escape($data['fax']) . "' WHERE customer_id = '" . (int)$customer_id . "'");
					$this->event->trigger('post.customer.edit', $customer_id);
				}
